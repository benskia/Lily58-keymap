...
[_LOWER] = LAYOUT(
  _______, KC_LBRC, KC_LCBR, KC_LPRN, KC_LABK, _______,                   _______, KC_RABK, KC_RPRN, KC_RCBR, KC_RBRC, _______,
...
[_RAISE] = LAYOUT(
  _______, KC_PLUS, KC_MINS, KC_ASTR, KC_SLSH, KC_EXLM,                   _______, _______, _______, _______, _______, _______,
  _______, KC_AT,   KC_PIPE, KC_AMPR, KC_BSLS, KC_TILD,                   KC_HOME, KC_PGDN, KC_PGUP, KC_END,  _______, _______,
  _______, _______, _______, _______, _______, KC_UNDS,                   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, KC_GRV,
